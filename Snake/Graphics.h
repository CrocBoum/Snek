...
public:
	...
	void DrawRectByCorners(int x0, int y0, int x1, int y1, Color c);
	...
	void DrawDonut(int cx, int cy, int rad, int width, Color c);
	void DrawCircle(int cx, int cy, int rad, Color c) {
		DrawDonut(cx, cy, rad, 0, c);
	}
	~Graphics();
private:
